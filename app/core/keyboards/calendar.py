...
class Calendar:
    ...
    async def start_calendar(
        ...
        inline_kb.insert(InlineKeyboardButton(
            f'{_get_ru_month(calendar.month_name[month])} {str(year)}',
        ...
        inline_kb.row()
        for day in ["Пон", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс"]:
    ...
    async def process_selection(self, query: CallbackQuery, data: CallbackData | dict) -> tuple:
        """
